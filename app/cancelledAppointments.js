      ...
      <ScrollView showsVerticalScrollIndicator={false}>
       <View style={{borderBottomColor:"#DBD0C8", borderBottomWidth:1, height:40}}>
        <View style={{borderColor:"red", height:30, flexDirection:"row", justifyContent:"space-between"}}>
          ...
          <TouchableOpacity style={{borderColor:"blue",  justifyContent:"center", flexDirection:"row", width:"30%"}} onPress={() => {navigation.navigate('cancelledAppointments')}}>
        ...
        <View style={{borderColor:"red", width:"91%", marginLeft:"5%", height:8, flexDirection:"row", justifyContent:"space-between"}}>
            ...
            <View style={{borderColor:"blue", backgroundColor:"#30B3DE", borderTopLeftRadius:4, borderTopRightRadius:4, borderBottomRightRadius:4, borderBottomLeftRadius:4, justifyContent:"center", height:"60%", width:"25%"}}></View>
        </View>
       </View>
