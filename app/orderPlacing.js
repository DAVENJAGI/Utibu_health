      ...
      <View style={{borderColor:"red", marginTop:"3%", height:30}}>
        ...
        {isModalVisible && (
            <View sytyle={{ borderRadius:9, width:"100%"}}>
                <View style={{shadowOpacity: 0.25, borderWidth:1, borderColor:"#E3E3E3", shadowOffset: { width: 0,  height: 2,}, shadowColor: 'black', shadowRadius: 3.84, elevation: 15, borderRadius:8,  backgroundColor:"white", zIndex:22, top:0, bottom:0, position:"absolute", height:180, margin:"5%", width:"90%"}}>
                    <View style={{orderColor:"red", height:"60%", justifyContent:"center"}}>
                        <Text style={{textAlign:"center",alignItems:"center", fontSize:18, fontWeight:600}}>Are you sure you want to place an order?</Text>
                    </View>
